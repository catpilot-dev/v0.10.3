...
class AlertRenderer(Widget):
  ...
  def _draw_icons(self, alert_layout: AlertLayout) -> None:
    ...
    rl.draw_texture_ex(alert_layout.icon.texture, rl.Vector2(pos_x, int(self._rect.y + alert_layout.icon.margin_y)),
                       0.0, 1.0, rl.Color(255, 255, 255, int(icon_alpha * self._alpha_filter.x)))
